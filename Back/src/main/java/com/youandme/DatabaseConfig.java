...
public class DatabaseConfig {
    ...
    public SessionFactory getSessionFactory(DataSource dataSource) throws Exception {
        ...
        properties.put("hibernate.hbm2ddl.auto", env.getProperty("spring.jpg.hibernate.hbm2ddl.auto"));
...
//        System.out.println("Mọi lần là để nó tự config nhưng lần này là config bằng tay nên là nó lạ lol ghê");
